...
import com.dcat.ReCo.filters.JwtRequestFilter;
import com.dcat.ReCo.utils.JwtAuthenticationEntryPoint;
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.csrf().disable().cors().configurationSource(request -> {
			...
			return cors;
				...
				// request start with '/admin' must be authorized with
//				.authorizeRequests().antMatchers("/admin/*")
//				.hasAuthority(AppConst.Role.ROLE_PREFIX + AppConst.Role.ADMIN).and().
